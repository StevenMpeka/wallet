...
app.get("/pay",requireLogin, (req, res) => {
  res.sendFile(path.join(__dirname + "/landingPage.html")); //__dirname : It will resolve to your project folder.
});

app.get("/response",requireLogin, async (req, res) => {
...
app.get("/wallet/:userId/balance",requireLogin, async (req, res) => {
  try {
